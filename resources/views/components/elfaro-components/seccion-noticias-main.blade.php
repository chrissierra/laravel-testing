<div class="row" id="contenedorPrincipalNoticias">
    ...
    <div class=" col-12 col-lg-4">
        <div class="card card-noticias-main ">
            <img class="img-fluid imagen-main" src="1.jpg">
            <div class="card-body">
    ...
    <div class=" col-12 col-lg-4">
        <div class="card card-noticias-main ">
            <img  class="img-fluid imagen-main" src="2.jpeg">
            <div class="card-body">
    ...
    <div class=" col-12 col-lg-4">
        <div class="card  card-noticias-main ">
            <div class="row ">
                <div class="col-12 ">
                    <iframe width="320" height="215" class="rounded-3 imagen-main" src="https://www.youtube.com/embed/dfKgVKxHa3M">
                    </iframe>
                </div>
            </div>
            <div class="card-body">
